...
//
//   SIMICS_REMOTE_HOST empty  the command runs on this machine, in the project
//   SIMICS_REMOTE_HOST set    the project is archived, copied to that host over
...
const REMOTE_VARIABLES = {
  host: 'SIMICS_REMOTE_HOST',
  user: 'SIMICS_REMOTE_USER',
  basePath: 'SIMICS_REMOTE_BASE_PATH',
  projectName: 'SIMICS_REMOTE_PROJECT_NAME',
  port: 'SIMICS_REMOTE_PORT',
  identityFile: 'SIMICS_REMOTE_IDENTITY_FILE',
};
