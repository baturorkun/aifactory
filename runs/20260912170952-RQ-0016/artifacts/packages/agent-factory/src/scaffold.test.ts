...
test('simics template scaffolds the hardware-twin probe workflow without naming any machine', () => {
  ...
  try {
    ...
    for (const name of ['SIMICS_REMOTE_HOST', 'SIMICS_REMOTE_USER', 'SIMICS_REMOTE_PORT', 'SIMICS_REMOTE_BASE_PATH',
      'SIMICS_REMOTE_PROJECT_NAME', 'SIMICS_REMOTE_IDENTITY_FILE', 'SIMICS_REMOTE_TOOLCHAIN_BIN',
